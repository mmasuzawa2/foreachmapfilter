...
const sampleStrArr = ["err","tide","gyoza","pizza"];
const sampleObj = [{name: 'Elie'}, {name: 'Tim'}, {name: 'Matt'}, {name: 'Colt'}];
...
function vowelCount(str){
    ...
    vowels.forEach(function(vowel){
       newObj[vowel] = lowerCased.split(vowel).length-1;
